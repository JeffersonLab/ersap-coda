 ...
 */
public class CodaRemoteETReader implements IASource, Runnable {
    ...
    public CodaRemoteETReader(String etName, int etPort, String etStationName, int capacity) {
        // Queue staff
        ...
        try {
            ...
            config.setHost("indra-s3.jlab.org");
